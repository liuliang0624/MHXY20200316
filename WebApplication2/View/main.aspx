<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="WebApplication2.View.Test" %>
        ...
        <div>
            <div style="height: 602px; width: 1137px">
                <div style="width: 500px; height: 400px; top: 500px; right: 10px; clip: rect(300px, auto, auto, auto); left: 100px;">
                    <input id="File1" type="file" /><asp:LinkButton ID="LinkButton1" runat="server">LinkButton</asp:LinkButton>
